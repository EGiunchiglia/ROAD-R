...
# smooth l1 with beta
from modules.req_losses import logical_requirements_loss
...
class FocalLoss(nn.Module):
    ...
    # def forward(self, confidence, predicted_locations, gt_boxes, gt_labels, counts, anchors):
    def forward(self, confidence, predicted_locations, gt_boxes, gt_labels, counts, anchors, logic, Cplus, Cminus):
        ...
        if logic is None:
            ...
            logic_based_loss = logical_requirements_loss(masked_preds, masked_labels, num_pos, self.alpha, self.gamma, logic, Cplus, Cminus)
